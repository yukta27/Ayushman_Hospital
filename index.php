...
Ambulance Services</a></h3>
									<p>24 hours patient transport vehicle available. Patients are transported from home (on campus) to Ayushman hospital and patients referred by emergency duty doctor to empanelled hospital for specialized case.</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="about-grid n-about-grid n-about-grid1">
								...
								<div class="about-grid-info text-center">
									...
									<p>Trained laboratory staff are providing best services which includes painless blood withdrawal Services of one NABL accredited laboratory are also available for carrying out specialised tests.Sample collection time for Ayushman laboratory is 8 am to 10.30 am while emergency tests like Blood sugar, platelet count & Hb & blood grouping done in emergent cases throughout OPD hours.
</p>
								</div>
							</div>
						</div>
						...
						<div class="contact-grids">
							...
							<div class="col-md-5 contact-grid-left">
								...
								<ul>
									...
									<li><span class="pin"> </span><label>Address :</label><small>Ayushman Hospital,100 Feet Ring Road,BSK 3rd Stage,Hoskerehalli,Bangalore-560 085</small></li>
									...
									<li><span class="mail"> </span><label>Email :</label><small> info@Ayushmanhospitals.com</small></li>
								</ul>
							</div>
